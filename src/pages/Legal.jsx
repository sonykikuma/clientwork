          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-8 mb-4 mb-md-0">
              <div className="p-4 bg-white shadow-sm rounded-4 h-100">
                <h4 className="fw-bold mb-3">Legal Activities:</h4>
                {/* <ul className="mb-3">
            ...
            <div className="col-md-4">
              <div className="bg-white shadow-sm rounded-4 overflow-hidden h-100 d-flex align-items-center">
                <img
                  src="https://images.stockcake.com/public/3/5/2/3526b0a1-8f3a-4046-bf30-e3aecaa0b2c7_large/legal-agreement-handshake-stockcake.jpg"
                  alt="legal"
